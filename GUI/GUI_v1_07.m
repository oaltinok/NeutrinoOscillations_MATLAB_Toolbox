function varargout = GUI_v1_07(varargin)
% GUI_V1_07 MATLAB code for GUI_v1_07.fig
%      GUI_V1_07, by itself, creates a new GUI_V1_07 or raises the existing
%      singleton*.
%
%      H = GUI_V1_07 returns the handle to a new GUI_V1_07 or the handle to
%      the existing singleton*.
%
%      GUI_V1_07('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_V1_07.M with the given input arguments.
%
%      GUI_V1_07('Property','Value',...) creates a new GUI_V1_07 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before GUI_v1_07_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to GUI_v1_07_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help GUI_v1_07

% Last Modified by GUIDE v2.5 04-Oct-2012 15:11:54

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @GUI_v1_07_OpeningFcn, ...
                   'gui_OutputFcn',  @GUI_v1_07_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GUI_v1_07 is made visible.
function GUI_v1_07_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GUI_v1_07 (see VARARGIN)

% Choose default command line output for GUI_v1_07
...
% UIWAIT makes GUI_v1_07 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = GUI_v1_07_OutputFcn(hObject, eventdata, handles) 
