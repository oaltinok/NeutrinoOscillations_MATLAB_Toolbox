function varargout = GUI_v2_01(varargin)
%% GUI_V2_01 MATLAB code for GUI_v2_01.fig

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @GUI_v2_01_OpeningFcn, ...
    'gui_OutputFcn',  @GUI_v2_01_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before GUI_v2_01 is made visible.
function GUI_v2_01_OpeningFcn(hObject, eventdata, handles, varargin)
...
% UIWAIT makes GUI_v2_01 wait for user response (see UIRESUME)
% uiwait(handles.figure1);
end


% --- Outputs from this function are returned to the command line.
function varargout = GUI_v2_01_OutputFcn(hObject, eventdata, handles)
...
function distance_box_Callback(hObject, eventdata, handles)
    ...
    if distance < 100
        set(hObject, 'String', 0);
        errordlg('Input must be higher than 100km','Error');
    end
...
function edit_det_eff_Callback(hObject, eventdata, handles)
    
    det_eff = str2double(get(hObject,'String'));
    ...
    if det_eff < 0
        set(hObject, 'String', 0);
        errordlg('Detector Efficiency can not be lower than 0','Error');
    end

    if det_eff > 1
        set(hObject, 'String', 0);
        errordlg('Detector Efficiency can not be higher than 1','Error');
    end

    handles.det_eff = det_eff;
...
function edit_det_eff_CreateFcn(hObject, eventdata, handles)
